...
# 姓氏权重表：数值越大表示该姓氏在人口中越常见
# 朱 权重为 0 —— 明朝皇族姓，普通官员回避使用
_OFFICIAL_SURNAME_WEIGHT_MAP = {
    # 超大姓 (10)
    "张": 10, "王": 10, "李": 10,
    # 大姓 (7-8)
    "刘": 8,  "陈": 8,
...
# 预计算 population / weights，供 random.choices 使用
OFFICIAL_SURNAMES = list(_OFFICIAL_SURNAME_WEIGHT_MAP.keys())
OFFICIAL_SURNAME_WEIGHTS = list(_OFFICIAL_SURNAME_WEIGHT_MAP.values())

# 官员名字池与地主名字池已合并 —— 统一在 agent_defs/agents.py 维护
from ..agent_defs.agents import GENTRY_GIVEN_NAMES as OFFICIAL_GIVEN_NAMES  # noqa: E402
