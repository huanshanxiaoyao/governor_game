...
PromptRegistry.register(
    ...
    system=(
        ...
        '【明代赋税征收节奏】\n'
        '农赋（地丁）分夏秋两税，时间表如下：\n'
        '- 正月至四月：本年征收尚未开始，完成率接近0%完全正常，不应催科\n'
        '- 五月至六月：夏税征收期（夏粮刚熟），预期完成年度农赋约15~32%\n'
        '- 七月至八月：夏税收尾，秋收前，预期完成约38~42%\n'
        '- 九月至十月：秋税征收旺季，预期完成约62~88%\n'
        '- 十一月至十二月：年度收尾，应接近或达到100%\n'
        '据此判断：六月看到完成率低（如20%以下），属正常；真正的滞后警报应在八月以后。\n'
        'directive="催科" 应仅在八月及之后、且完成率显著低于当月时令预期时才使用。\n'
        '\n'
        '【可选行动】\n'
