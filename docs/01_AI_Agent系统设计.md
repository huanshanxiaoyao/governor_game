...
### 6.3 师爷（幕僚）
- **定位**：游戏助理 + 新人引导 + 策略顾问
- **实现**：沈清远（ADVISOR, FULL tier），绍兴师爷世家出身，精通刑名钱谷
- **游戏知识**：LLM提示词中注入「治县要略」，涵盖财政、民心、投资、灾害等核心机制
- **问策限制**：每季度可问策 `advisor_level` 次（默认1次），超出则拒绝回答
- **回答风格**：只提供定性分析（"百姓怨声渐起"），不透露精确数值
- **行为逻辑**：基于自身性格和认知给建议，建议带有师爷自己的偏见——不一定是最优解

### 6.3b 县丞（副手）
- **定位**：县衙副手，辅助治理 + 可对话的第二幕僚
- **实现**：周正卿（DEPUTY, FULL tier），八品官员，举人出身，熟稳公务流程
- **游戏知识**：同样注入「治县要略」
- **对话**：无次数限制，可随时交谈
- **行为逻辑**：谨慎务实、循规蹈矩，建议偏保守
...
| 角色 | 数量 | 层级 | 说明 |
|------|------|------|------|
| 师爷 | 1 | FULL | 沈清远，首席顾问，注入游戏知识 |
| 知府 | 1 | FULL | 赵廷章，玩家直属上级，最重要的博弈对象 |
| 县丞 | 1 | FULL | 周正卿，副手，注入游戏知识 |
| 耆老 | 1 | LIGHT | 李秀才，民间舆论风向标 |
| 里长 | 1 | LIGHT | 张铁根，基层民意代表 |
| 地主 | 6 | FULL | 各村地主（李德厚、张守业、王伯丰、陈文礼、赵元亨、刘三旺） |
| 村民代表 | 6 | FULL | 各村代表（李四、张大嫂、王铁柱、陈小六、赵老三、刘二妮） |
| **合计** | **17** | | 5固定角色 + 6地主 + 6村民代表 |

> 注：原设计中的邻县县令、商户代表、考核委员、京官来访等角色在MVP实现中暂未纳入。
